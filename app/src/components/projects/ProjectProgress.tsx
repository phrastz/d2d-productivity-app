    ...
    <div className="space-y-4">
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          <h3 className="text-sm font-semibold text-slate-800 dark:text-slate-100">Overall Progress</h3>
          <span className={`text-2xl font-bold ${getProgressTextColor(overallProgress)}`}>
            {overallProgress}%
          </span>
        </div>
        <div className="h-3 bg-slate-200 dark:bg-slate-800/50 rounded-full overflow-hidden">
          <div
